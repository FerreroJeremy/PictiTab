...
public class UITools {
	 ...
	 *            (Display): Display
	 * @param orientation
	 *            (int): Code of the orientation
	 * @param pictureWidth
	 *            (int): Width of the pictures
	 * @param padding
	 *            (int): Padding
	 * @return Column number in the grid
	 **/
	public static int getNbColumn(Display display, int orientation,
			int pictureWitdth, int padding) {
		int nbCols;
		...
		if (orientation == Configuration.ORIENTATION_PORTRAIT) {
			...
			nbCols = (int) Math
					.ceil(height / (pictureWitdth + 2 * padding) - 1);
		}
		return nbCols;
	}
	 ...
	 *            (int): Width of the pictures
	 * @param nbCols
	 *            (int): Column number in the grid
	 * @return Padding
	 **/
	public static int getNewPadding(Display display, int orientation,
			int pictureWidth, int nbCols) {
		int newPadding;
		Point size = new Point();
		display.getSize(size);
		int width = size.x;
