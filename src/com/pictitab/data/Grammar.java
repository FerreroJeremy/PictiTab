...
public class Grammar implements Parcelable {
	...
	/**
	 * Constructor.
	 * @param name(String): Grammars's name.
	 **/
	 ...
	 * Copy constructor.
	 * @param name(String): Grammars's name.
	 * @param rules(ArrayList<ArrayList<Category>>): List of rules.
	 **/
	...
	/**
	 * Set a rule of indice i.
	 * @param i(int): Indice.
	 * @param rule(ArrayList<Category>): Rule.
	 **/
	...
	/**
	 * Return the category of indice j in the rule of indice i.
	 * @param i(int): Rule's indice.
	 * @param j(int): Category's indice.
	 * @return Category.
	 **/
	...
	/**
     * Set a category of indice j in the rule of indice i.
     * @param i(int): Rule's indice.
     * @param j(int): Category's indice.
	 **/
