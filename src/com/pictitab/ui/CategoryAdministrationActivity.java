...
public class CategoryAdministrationActivity extends Activity {
	...
	private void toDisplay() {
		...
		// (mode = 0) : Creation of a category in a sub-category of the category
		// "nom"
		if (mode == 0) {
	 ...
	 * 
	 * @param nom
	 *            (String): The name of the category in the Data.
	 **/
	private void modifyCategoryToDisplay(final String nom) {
		categoryName.setText(nom);

		valideButton.setText(R.string.rename);
		titre.setText(R.string.new_name);
		...
		valideButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				AlertDialog.Builder ab = new AlertDialog.Builder(
						CategoryAdministrationActivity.this);
				ab.setTitle(R.string.modify)
						.setMessage(R.string.dialog_box_rename)
	...
	/**
	 * Display the window for the creation of a category in sub-category of the
	 * other.
	 **/
	protected void createChildCategoryToDisplay(final String nom) {
		titre.setText(R.string.new_name);
		// Action of creation button
		valideButton.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				// Add a category
	...
	protected void addSubCategory(String name) {
		...
		// Add a new category
			...
			Category mother = data.getCategories().get(
	 ...
	 * 
	 * @param oldName
	 *            (String): The name of the category to modify.
	 **/
