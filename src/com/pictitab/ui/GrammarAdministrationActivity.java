...
public class GrammarAdministrationActivity extends Activity {
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		GrammarAdministrationActivity.data = (AppData) data.getBundleExtra(
				MainActivity.DATAEXTRA_KEY)
				.getParcelable(MainActivity.DATA_KEY);
		GrammarAdministrationActivity.grammarReturn = data
				.getStringExtra("nom");
	}
	...
	private void toDisplay() {
		...
		if (nameByIntent != null) {
			...
			if (GrammarAdministrationActivity.grammarReturn != null) {
				GrammarAdministrationActivity.grammarName
						.setText(GrammarAdministrationActivity.grammarReturn);
			}
		...
		rulesAdapter = new ExpandableTreeAdapter(this, 3, listDataHeaderRules,
				listDataChildRules);
	...
	private void prepareListDataRules() {
		String grammarName = GrammarAdministrationActivity.grammarName
				.getText().toString();
	...
	private void saveGrammar() {
		// Rename
		final String newName = GrammarAdministrationActivity.grammarName
				.getText().toString();
		if (newName.equals("")) {
	...
	private void saveNewGrammar() {
		...
		final String nameInTextView = GrammarAdministrationActivity.grammarName
				.getText().toString();
	...
	private void createRuleWithoutGrammar() {
		...
		if (nameInTextView.equals("")) {
			...
			Intent intent = new Intent(GrammarAdministrationActivity.this,
					RuleAdministrationActivity.class);
		...
		editRule.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (GrammarAdministrationActivity.nameByIntent == null) {
					nameToIntent = GrammarAdministrationActivity.grammarName
							.getText().toString();
				} else
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						case DialogInterface.BUTTON_POSITIVE:
							...
							if (GrammarAdministrationActivity.nameByIntent == null) {
								...
								nameToIntent = GrammarAdministrationActivity.nameByIntent;
							data.getGrammarByName(nameToIntent).deleteRule(
									indice);
