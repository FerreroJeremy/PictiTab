...
public class SelectCategoryActivity extends Activity {
	...
	private ImageButton previousButton;							// Boutton to go back to parent category
    ...
    static HashMap<String, List<String>> listDataChildAllCat;	// List of sub-categories grouped by categories
	...
	private void initialiseButtons() {	
		...
		// Action of the category supression button
